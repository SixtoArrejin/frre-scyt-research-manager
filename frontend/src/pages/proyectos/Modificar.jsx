    ...
    if (data) {
      reset({
        proyecto: {
          ...
          ...(data.proyecto.fechaInicio && { fechaInicio: formatoFechaISOaAAAAMMDD(data.proyecto.fechaInicio) }),
          ...(data.proyecto.fechaFin && { fechaFin: formatoFechaISOaAAAAMMDD(data.proyecto.fechaFin) }),
