import { Card, CardBody, CardFooter, Text, Heading, Box, Spinner } from '@chakra-ui/react';
...
export default function Home() {
  ...
  const proyectosNoCompletos = dataProyectos?.proyectos?.filter((proyecto) => !proyecto.completo).length;
  ...
  const vinculacionesExternas = dataVinculaciones?.vinculaciones?.filter((vinculacion) => vinculacion.vinculacionessinfinanciamiento === null).length;
  ...
  return (
    <Box margin='10px' display='flex' justifyContent='center' marginTop='3rem'>
      <Stack direction={{ base: 'column', md: 'row' }} wrap='wrap' spacing='30px' justify='center' align='center' w='100%'>
